...
if ATTACK_NAME == "CW":
    iters = 11  # <-- Set your c value here
    adv_file = f"Adv_{ATTACK_NAME}_iters_{iters}.npy"
    plot_path = f"{root_path}/{ATTACK_NAME}/verify/{ATTACK_NAME}_plot_iters_{iters}.png"
...
if ATTACK_NAME == "CW":
    from CW import fetch_data, split_data, preprocess_data  # Import functions for consistency
...
if ATTACK_NAME == "CW":
    plt.suptitle(f"{ATTACK_NAME} Adversarial vs Original Images (max_iters={iters})", fontsize=14)
