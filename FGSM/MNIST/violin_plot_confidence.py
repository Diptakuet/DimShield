...
plot_path = os.path.join(conf_dir, 'violin_plot_confidence_comparison_all_eps.png')
...
# Load each eps file and extract max confidence
...
plt.title('Violin Plot of Highest Confidence: Original vs All Epsilons')
